...
<%@page import="com.tech.blog.helper.PostHelper" %>
...
class="fa fa-asterisk"></span> SkyBlog</a>
...
class=" fa fa-bell-o"></span> LearnCode With Sky <span
...
class="fa fa-asterisk"></span> Create Post</a></li>
</ul>
...
<div>
<img src="profilepics/<%=user.getProfile()%>"
style="border-radius: 150px; max-width: 100px;"
class="img-fluid" style="border-radius:50px;max-width:100;;">
</div>
<br />
<div>
...
name="gender" value="<%=user.getGender().toUpperCase()%>"></td>
</tr>
<tr>
<td>About</td>
<td><textarea class="form-control" name="user_about"><%=user.getAbout()%></textarea>
</td>
</tr>
<tr>
<td>New Profile</td>
...
<% 
PostHelper p=new PostHelper(ConnectionProvider.getConn());
ArrayList<Categories> c=p.getAllCategories();
for(Categories print:c){
%>
<option><%= print.getName()%></option>
<%
}%>
</select>
</div>
...
<div class="form-group">
<textarea style="height: 200px" class="form-control"
placeholder="Enter Code here (Optional)..."></textarea>
</div>
<div class="form-group">
<label>Upload your pic..</label> <br /> <input type="file" />
</div>
</form>
</div>
<div class="modal-footer">
